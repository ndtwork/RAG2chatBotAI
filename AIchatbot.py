...
# Replace "deepsick-model-name" with the actual model name and "YOUR_DEEPSICK_API_KEY" with your API key
embeddings = HuggingFaceEmbeddings(model_name="hieuduong29", api_key="sk-6182325efac04235aec669b4854dfc31")
